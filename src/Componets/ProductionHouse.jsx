...
function ProductionHouse() {
  ...
  return (
    <div className='flex  gap-2 md:gap-5 p-2 px-1 md:px-10'>
{productionHouseList.map((item)=> (
  ...
  shadow-xl shadow-gray-800'>
    ...
    className='absolute top-0 rounded-md z-0 opacity-0 hover:opacity-60'/>
    <img src= {item.image} alt="" className=' z-[1] ' />
