...
function Slider() {
  ...
  useEffect(() => {
    ...
    // Clear interval when component is unmounted or when the user interacts with the slider
    return () => clearInterval(interval);
  }, [movieList]); // Restart autoplay when movieList changes
  ...
  return (
    <div>
      ...
      <div
        ...
        ref={elementRef}
        onMouseEnter={() => clearInterval(interval)} // Clear interval on mouse enter
        onMouseLeave={() => {
